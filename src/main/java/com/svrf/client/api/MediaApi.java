...
public class MediaApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getTrendingCall(List<MediaType> type, String stereoscopicType, String category, Integer size, String nextPageCursor, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getTrendingValidateBeforeCall(List<MediaType> type, String stereoscopicType, String category, Integer size, String nextPageCursor, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public TrendingResponse getTrending(List<MediaType> type, String stereoscopicType, String category, Integer size, String nextPageCursor) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TrendingResponse> getTrendingWithHttpInfo(List<MediaType> type, String stereoscopicType, String category, Integer size, String nextPageCursor) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getTrendingAsync(List<MediaType> type, String stereoscopicType, String category, Integer size, String nextPageCursor, final ApiCallback<TrendingResponse> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call searchCall(String q, List<MediaType> type, String stereoscopicType, String category, Integer size, Integer pageNum, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call searchValidateBeforeCall(String q, List<MediaType> type, String stereoscopicType, String category, Integer size, Integer pageNum, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public SearchMediaResponse search(String q, List<MediaType> type, String stereoscopicType, String category, Integer size, Integer pageNum) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<SearchMediaResponse> searchWithHttpInfo(String q, List<MediaType> type, String stereoscopicType, String category, Integer size, Integer pageNum) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call searchAsync(String q, List<MediaType> type, String stereoscopicType, String category, Integer size, Integer pageNum, final ApiCallback<SearchMediaResponse> callback) throws ApiException {
