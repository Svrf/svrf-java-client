...
public class MediaApiTest {
    ...
    public void vrSearchqqGetTest() throws ApiException {
        ...
        InlineResponse200 response = api.vrSearchqqGet(q, type, stereoscopicType, size, pageNum);
    ...
    public void vrTrendingGetTest() throws ApiException {
        ...
        InlineResponse2002 response = api.vrTrendingGet(size, nextPageCursor);
